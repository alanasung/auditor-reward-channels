...
from cotobf.configs.loader import register_schema
...
def _load_stage_registry(package: str = "cotobf") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in cotobf.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from cotobf.configs.loader import config_to_dict, save_resolved_config
    from cotobf.models.device import get_device
    from cotobf.utils.logging import configure_logging
    from cotobf.utils.reproducibility import set_seed
    from cotobf.utils.run_manifest import create_run_dir, save_run_metadata

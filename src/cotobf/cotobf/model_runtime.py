"""Local causal-LM loading with explicit synthetic fallback."""
...
def try_load_causal_lm(
    ...
    *,
    ...
    if revision is None:
        try:
            from cotobf.models.registry import get_model_spec
...
def generate_text(
    ...
    *,
    ...
    kwargs: dict[str, Any] = {"max_new_tokens": max_new_tokens, "pad_token_id": tok.pad_token_id}

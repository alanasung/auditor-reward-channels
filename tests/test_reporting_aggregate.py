import json
from cotobf.reporting.aggregate import aggregate_results, flatten_metrics
from cotobf.reporting.tables import write_tables
from cotobf.reporting.figures import write_caption, write_figures
